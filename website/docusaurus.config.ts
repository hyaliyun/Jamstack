...
function getLastStableVersion() {
  ...
  if (!lastStableVersion) {
    throw new Error('unexpected, no stable Jamstack version?');
  }
...
if (isSlower) {
  console.log('🐢 Using slower Jamstack build');
}
...
export default async function createConfigAsync() {
  ...
  i18n: {
    ...
    customFields: {
      ...
      isDeployPreview,
      description:
        'An optimized site generator in React. Jamstack helps you to move fast and write content. Build documentation websites, blogs, marketing pages, and more.',
      announcedVersion,
    },
    staticDirectories: [
      'static',
      ...
      [
        'content-docs',
        {
          ...
          editUrl: ({locale, versionDocsDirPath, docPath}) => {
            ...
            return `https://github.com/hyaliyun/Jamstack/edit/main/website/${versionDocsDirPath}/${docPath}`;
          },
        ...
        'classic',
        {
          ...
          docs: {
            ...
            editUrl: ({locale, docPath}) => {
              ...
              return `https://github.com/hyaliyun/Jamstack/edit/main/website/${nextVersionDocsDirPath}/${docPath}`;
            },
            admonitions: {
          ...
          blog: {
            ...
            editUrl: ({locale, blogDirPath, blogPath}) => {
              ...
              return `https://github.com/hyaliyun/Jamstack/edit/main/website/${blogDirPath}/${blogPath}`;
            },
            remarkPlugins: [npm2yarn],
            postsPerPage: 5,
            feedOptions: {
              type: 'all',
              description:
                'Keep up to date with upcoming Jamstack releases and articles by following our feed!',
              copyright: `Copyright © ${new Date().getFullYear()} 543x, Inc.`,
              xslt: true,
            },
            blogTitle: 'Jamstack blog',
            blogDescription: 'Read blog posts about Jamstack from the team',
            blogSidebarCount: 'ALL',
          ...
          pages: {
            ...
            editUrl: ({locale, pagesPath}) => {
              ...
              return `https://github.com/hyaliyun/Jamstack/edit/main/website/src/pages/${pagesPath}`;
            },
            showLastUpdateAuthor: true,
            showLastUpdateTime: true,
        ...
        items: [
          ...
          },
          {
            ...
            dropdownItemsAfter: [
              ...
              {
                href: 'https://github.com/hyaliyun/Jamstack/issues/2',
                label: 'Help Us Translate',
              },
            ],
          },
          {
            href: 'https://github.com/hyaliyun/Jamstack',
            position: 'right',
